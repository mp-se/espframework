...
// ************************************************************************
// #define ESPFWK_DISABLE_LOGGING

#define ESPFWK_LEVEL_SILENT 0
#define ESPFWK_LEVEL_FATAL 1
#define ESPFWK_LEVEL_ERROR 2
#define ESPFWK_LEVEL_WARNING 3
#define ESPFWK_LEVEL_INFO 4
#define ESPFWK_LEVEL_NOTICE 4
#define ESPFWK_LEVEL_TRACE 5
#define ESPFWK_LEVEL_VERBOSE 6
...
/**
 * ArduinoLog is a minimalistic framework to help the programmer output log
 * statements to an output of choice, fashioned after extensive logging
 * libraries such as log4cpp ,log4j and log4net. In case of problems with an
 * application, it is helpful to enable logging so that the problem can be
 * located. ArduinoLog is designed so that log statements can remain in the code
 * with minimal performance cost. In order to facilitate this the loglevel can
 * be adjusted, and (if your code is completely tested) all logging code can be
 * compiled out.
 *
 * ---- Wildcards
 *
 * %s	display as string (char*)
 * %S   display as string from flash memory (__FlashStringHelper* or char[]
 * PROGMEM) %c	display as single character %C   display as single character or
 * as hexadecimal value (prefixed by `0x`) if not a printable character %d
 * display as integer value %l	display as long value %u	display as
 * unsigned long value %x	display as hexadecimal value %X	display as
 * hexadecimal value prefixed by `0x` and leading zeros %b	display as
 * binary number %B	display as binary number, prefixed by `0b` %t	display
 * as boolean value "t" or "f" %T	display as boolean value "true" or
 * "false" %D,%F display as double value %p    display a  printable object
 *
 * ---- Loglevels
 *
 * 0 - ESPFWK_LEVEL_SILENT     no output
 * 1 - ESPFWK_LEVEL_FATAL      fatal errors
 * 2 - ESPFWK_LEVEL_ERROR      all errors
 * 3 - ESPFWK_LEVEL_WARNING    errors and warnings
 * 4 - ESPFWK_LEVEL_INFO       errors, warnings and notices
 * 4 - ESPFWK_LEVEL_NOTICE     Same as INFO, kept for backward compatibility
 * 5 - ESPFWK_LEVEL_TRACE      errors, warnings, notices, traces
 * 6 - ESPFWK_LEVEL_VERBOSE    all
 */
...
class Logging {
 public:
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_FATAL, false, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_FATAL, true, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_ERROR, false, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_ERROR, true, msg, args...);
#endif
  }
  /**
   ...
   * loglevels >= ESPFWK_LEVEL_WARNING
   *
   * \param msg format string to output
   * \param ... any number of variables
   * \return void
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_WARNING, false, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_WARNING, true, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_NOTICE, false, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_NOTICE, true, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_INFO, false, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_INFO, true, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_TRACE, false, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_TRACE, true, msg, args...);
#endif
  }
   ...
   * loglevels >= ESPFWK_LEVEL_VERBOSE
   *
   * \param msg format string to output
   * \param ... any number of variables
   * \return void
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_VERBOSE, false, msg, args...);
#endif
  }
...
#ifndef ESPFWK_DISABLE_LOGGING
    printLevel(ESPFWK_LEVEL_VERBOSE, true, msg, args...);
#endif
  }
 ...
 private:
  ...
  void printLevel(int level, bool cr, T msg, ...) {
    ...
    if (level < ESPFWK_LEVEL_SILENT) {
      level = ESPFWK_LEVEL_SILENT;
    }
